...
func (_e *MockMsg_Expecter) DoubleAck(context1 any) *MockMsg_DoubleAck_Call {
...
//   - delay time.Duration
func (_e *MockMsg_Expecter) NakWithDelay(delay any) *MockMsg_NakWithDelay_Call {
...
//   - reason string
func (_e *MockMsg_Expecter) TermWithReason(reason any) *MockMsg_TermWithReason_Call {
