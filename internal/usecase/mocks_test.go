...
func (_mock *MockTaskerTasksRepository) GetTasks(ctx context.Context, filters models.GetTasksFilters) ([]models.Task, error) {
	ret := _mock.Called(ctx, filters)
	...
	var r0 []models.Task
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, models.GetTasksFilters) ([]models.Task, error)); ok {
		return returnFunc(ctx, filters)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, models.GetTasksFilters) []models.Task); ok {
		r0 = returnFunc(ctx, filters)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]models.Task)
...
func (_c *MockTaskerTasksRepository_GetTasks_Call) Return(tasks []models.Task, err error) *MockTaskerTasksRepository_GetTasks_Call {
	_c.Call.Return(tasks, err)
	return _c
}

func (_c *MockTaskerTasksRepository_GetTasks_Call) RunAndReturn(run func(ctx context.Context, filters models.GetTasksFilters) ([]models.Task, error)) *MockTaskerTasksRepository_GetTasks_Call {
	_c.Call.Return(run)
	return _c
}

// GetTasksByUserId provides a mock function for the type MockTaskerTasksRepository
func (_mock *MockTaskerTasksRepository) GetTasksByUserId(ctx context.Context, userId int, filters models.GetTasksByUserIdFilters) ([]models.Task, error) {
	...
	var r0 []models.Task
	var r1 error
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, models.GetTasksByUserIdFilters) ([]models.Task, error)); ok {
		return returnFunc(ctx, userId, filters)
	}
	if returnFunc, ok := ret.Get(0).(func(context.Context, int, models.GetTasksByUserIdFilters) []models.Task); ok {
...
func (_c *MockTaskerTasksRepository_GetTasksByUserId_Call) Return(tasks []models.Task, err error) *MockTaskerTasksRepository_GetTasksByUserId_Call {
	_c.Call.Return(tasks, err)
	return _c
}

func (_c *MockTaskerTasksRepository_GetTasksByUserId_Call) RunAndReturn(run func(ctx context.Context, userId int, filters models.GetTasksByUserIdFilters) ([]models.Task, error)) *MockTaskerTasksRepository_GetTasksByUserId_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockTasksRepository) GetTasks(ctx context.Context, filters models.GetTasksFilters) ([]models.Task, error) {
	ret := _mock.Called(ctx, filters)
...
func (_c *MockTasksRepository_GetTasks_Call) RunAndReturn(run func(ctx context.Context, filters models.GetTasksFilters) ([]models.Task, error)) *MockTasksRepository_GetTasks_Call {
	_c.Call.Return(run)
	return _c
}

// GetTasksByUserId provides a mock function for the type MockTasksRepository
func (_mock *MockTasksRepository) GetTasksByUserId(ctx context.Context, userId int, filters models.GetTasksByUserIdFilters) ([]models.Task, error) {
	ret := _mock.Called(ctx, userId, filters)
...
func (_c *MockTasksRepository_GetTasksByUserId_Call) RunAndReturn(run func(ctx context.Context, userId int, filters models.GetTasksByUserIdFilters) ([]models.Task, error)) *MockTasksRepository_GetTasksByUserId_Call {
	_c.Call.Return(run)
	return _c
}
