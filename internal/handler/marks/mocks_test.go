...
// ExportMarks provides a mock function for the type MockExporter
func (_mock *MockExporter) ExportMarks(ctx context.Context, filters models.GetMarksFilters, fn func(models.Mark) error) error {
	ret := _mock.Called(ctx, filters, fn)

	if len(ret) == 0 {
		panic("no return value specified for ExportMarks")
	}
...
// MockExporter_ExportMarks_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'ExportMarks'
type MockExporter_ExportMarks_Call struct {
	*mock.Call
}

// ExportMarks is a helper method to define mock.On call
//   - ctx context.Context
//   - filters models.GetMarksFilters
//   - fn func(models.Mark) error
func (_e *MockExporter_Expecter) ExportMarks(ctx any, filters any, fn any) *MockExporter_ExportMarks_Call {
	return &MockExporter_ExportMarks_Call{Call: _e.mock.On("ExportMarks", ctx, filters, fn)}
}

func (_c *MockExporter_ExportMarks_Call) Run(run func(ctx context.Context, filters models.GetMarksFilters, fn func(models.Mark) error)) *MockExporter_ExportMarks_Call {
...
func (_c *MockExporter_ExportMarks_Call) Return(err error) *MockExporter_ExportMarks_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockExporter_ExportMarks_Call) RunAndReturn(run func(ctx context.Context, filters models.GetMarksFilters, fn func(models.Mark) error) error) *MockExporter_ExportMarks_Call {
	_c.Call.Return(run)
	return _c
}

// newMockexportEncoder creates a new instance of mockexportEncoder. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func newMockexportEncoder(t interface {
	mock.TestingT
	Cleanup(func())
}) *mockexportEncoder {
	mock := &mockexportEncoder{}
	mock.Mock.Test(t)
...
// mockexportEncoder is an autogenerated mock type for the exportEncoder type
type mockexportEncoder struct {
	mock.Mock
}

type mockexportEncoder_Expecter struct {
	mock *mock.Mock
}

func (_m *mockexportEncoder) EXPECT() *mockexportEncoder_Expecter {
	return &mockexportEncoder_Expecter{mock: &_m.Mock}
}

// Begin provides a mock function for the type mockexportEncoder
func (_mock *mockexportEncoder) Begin() error {
	ret := _mock.Called()
...
// mockexportEncoder_Begin_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Begin'
type mockexportEncoder_Begin_Call struct {
	*mock.Call
}

// Begin is a helper method to define mock.On call
func (_e *mockexportEncoder_Expecter) Begin() *mockexportEncoder_Begin_Call {
	return &mockexportEncoder_Begin_Call{Call: _e.mock.On("Begin")}
}

func (_c *mockexportEncoder_Begin_Call) Run(run func()) *mockexportEncoder_Begin_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockexportEncoder_Begin_Call) Return(err error) *mockexportEncoder_Begin_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockexportEncoder_Begin_Call) RunAndReturn(run func() error) *mockexportEncoder_Begin_Call {
	_c.Call.Return(run)
	return _c
}

// End provides a mock function for the type mockexportEncoder
func (_mock *mockexportEncoder) End() error {
	ret := _mock.Called()
...
// mockexportEncoder_End_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'End'
type mockexportEncoder_End_Call struct {
	*mock.Call
}

// End is a helper method to define mock.On call
func (_e *mockexportEncoder_Expecter) End() *mockexportEncoder_End_Call {
	return &mockexportEncoder_End_Call{Call: _e.mock.On("End")}
}

func (_c *mockexportEncoder_End_Call) Run(run func()) *mockexportEncoder_End_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run()
	})
	return _c
...
func (_c *mockexportEncoder_End_Call) Return(err error) *mockexportEncoder_End_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockexportEncoder_End_Call) RunAndReturn(run func() error) *mockexportEncoder_End_Call {
	_c.Call.Return(run)
	return _c
}

// Write provides a mock function for the type mockexportEncoder
func (_mock *mockexportEncoder) Write(m models.Mark) error {
	ret := _mock.Called(m)
	...
	var r0 error
	if returnFunc, ok := ret.Get(0).(func(models.Mark) error); ok {
		r0 = returnFunc(m)
	} else {
		r0 = ret.Error(0)
	}
...
// mockexportEncoder_Write_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Write'
type mockexportEncoder_Write_Call struct {
	*mock.Call
}

// Write is a helper method to define mock.On call
//   - m models.Mark
func (_e *mockexportEncoder_Expecter) Write(m any) *mockexportEncoder_Write_Call {
	return &mockexportEncoder_Write_Call{Call: _e.mock.On("Write", m)}
}

func (_c *mockexportEncoder_Write_Call) Run(run func(m models.Mark)) *mockexportEncoder_Write_Call {
	_c.Call.Run(func(args mock.Arguments) {
		var arg0 models.Mark
		if args[0] != nil {
			arg0 = args[0].(models.Mark)
		}
		run(
			arg0,
		)
...
func (_c *mockexportEncoder_Write_Call) Return(err error) *mockexportEncoder_Write_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *mockexportEncoder_Write_Call) RunAndReturn(run func(m models.Mark) error) *mockexportEncoder_Write_Call {
	_c.Call.Return(run)
	return _c
}
