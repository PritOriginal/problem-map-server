...
func (suite *WebhookRouterSuite) TestConsumerNames() {
	suite.NotEqual(notifier.ConsumerName, notifier.WebhookConsumerName, "both consumers must receive every event")
	suite.Equal(nats.EventSubjects, notifier.WebhookSubjects)
}
