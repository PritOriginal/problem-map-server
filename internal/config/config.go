...
func (c *Config) Validate() error {
	if err := errors.Join(c.Auth.Validate(), c.DB.Validate(), c.Tasker.Validate(), c.Marks.Validate(), c.Comments.Validate(), c.Rating.Validate(), c.Push.Validate(), c.Nats.ValidateDelivery(), c.Export.Validate(), c.Webhooks.Validate(), c.REST.Idempotency.Validate(), c.Reports.Validate()); err != nil {
